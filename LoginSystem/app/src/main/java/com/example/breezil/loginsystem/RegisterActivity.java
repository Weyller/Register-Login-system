...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText eName = (EditText) findViewById(R.id.eNmae);
        ...
        final Button  eButton = (Button) findViewById(R.id.RegisterBtn);
        ...
        eButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Response.Listener<String> responseList = new Response.Listener<String>() {
                    @Override
                ...
                RegisterRequest registerRequest = new RegisterRequest(name, username, age, password, responseList);
